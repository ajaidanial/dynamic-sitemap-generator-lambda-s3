...
parser.add_argument(
    ...
    default=False,
    required=False,
    help="Ignore file defined in robots.txt",
)
parser.add_argument(
...
parser.add_argument(
    ...
    default=[],
    required=False,
    help="Drop a string from the url",
)
parser.add_argument(
    "--report",
    action="store_true",
...
group.add_argument(
    "--config", action="store", default=None, help="Configuration file in json format"
)
group.add_argument(
    "--domain",
    action="store",
    default="",
    help="Target domain (ex: http://blog.lesite.us)",
)
